# Graph Report - knowledge_base/unified_graph  (2026-09-01)
...
## Summary
- 717 nodes · 1219 edges · 45 communities (36 shown, 9 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.75)
...
- `Anagrafe Zero` --semantically_similar_to--> `RVE-54 Patient Query`  [INFERRED] [semantically similar]
  analisi_completa.md → Specifiche tecniche - Anagrafe Zero v2.6.pdf
...
- `Progetto SI.Ter` --conceptually_related_to--> `Digitalizzazione Elementi DM77`  [INFERRED]
  analisi_completa.md → SITER_presentazione alla Cabina di Regia_25 marzo 2026.pdf
- `RVE-121 GetAccessToken` --references--> `E-RVE121-001`  [INFERRED]
  Specifiche tecniche chiamata di contesto RVE v1.3_PC.pdf → 20260727T185227/experiment_summary.md
...
### Community 1 - "main.py"
Cohesion: 0.08
Nodes (53): to_json(), to_xml(), collect_logs(), Esegue la normalizzazione log ed eventualmente scrive il dataset JSON., _annotate_dataset_flows(), _append_json(), _build_namespace(), _cfg_section() (+45 more)
...
Cohesion: 0.07
Nodes (25): _build_parser(), _direct_vs_middleware_summary(), GraphGenerator, _load_config(), main(), MetricsCalculator, ArgumentParser, Genera grafici PNG direttamente dal dataset/metrics gia in memoria. (+17 more)

### Community 5 - "Progetto SI.Ter"
Cohesion: 0.06
...
### Community 7 - "Corrected Middleware Flow Outcomes"
Cohesion: 0.07
Nodes (34): Dependency resolution failure, Separazione dei fault iniettati dagli errori spontanei, Gateway timeout, Output extraction failure, Semantic validation failure, Tassonomia degli errori 20260727T185227, Transport timeout, E-FAULT-001 (+26 more)

### Community 8 - "collect_logs"
Cohesion: 0.10
Nodes (21): _build_parser(), _first_present(), _framework_event_key(), FrameworkLogParser, _load_config(), LogJoiner, main(), MiddlewareLogParser (+13 more)

### Community 9 - "RunTab"
Cohesion: 0.15
Nodes (3): Accoda l'aggiornamento progress nel main thread Tk., Controllo pipeline con progress bar e log thread-safe., RunTab

### Community 10 - "Request Dataset Generator RVE Guide"
Cohesion: 0.08
...
### Community 13 - "MockMiddlewareLogGenerator"
Cohesion: 0.13
...
### Community 15 - "flow_orchestrator.py"
Cohesion: 0.16
Nodes (11): Protocol, _new_uuid(), _payload_size(), Flow Orchestrator  Definisce i workflow RVE come catene ordinate di transazioni, Calcola la dimensione in byte del body della richiesta., Costruisce un flusso completo come lista di step pre-compilati.          In moda, Protocollo che ogni modulo rve_Xb.py deve soddisfare.      Un modulo Python è un, RveTransactionModule (+3 more)

### Community 16 - "SOAP/WSDL Integration Surface"
Cohesion: 0.16
Nodes (14): applicationUtils V1.0 WSDL, SPID/CIE-based Automatic FEA Enrolment, digitalStamp V1.0 WSDL, Scryba Sign 3.x Developer's Guide (V16), RetrieveIdentityDocument, Integration Certification Process, Scryba Sign Server, verifyValidations and RemoveEnvelopes (+6 more)

### Community 17 - "SOAP/WSDL Integration Surface"
Cohesion: 0.17
Nodes (12): FDR, Smart Card, and FEA Certificate Types, GetUserInfo4, HTTPS with Basic Authentication, DespatchOtp and VerifyOTP, Remote Digital Signature, CAdES, PAdES, XAdES, and Hash Signing, Signer Configuration, Signing Power and Signature Profile (+4 more)

### Community 18 - "flow_orchestrator.py"
Cohesion: 0.40
Nodes (8): endpoint_url(), Utility condivise per le transazioni SOAP ScrybaSign., resolve_auth_header(), resolve_mtls_profile(), build_request(), ScrybaSign GetUserInfo SOAP 1.1 request., build_request(), ScrybaSign SignOneDoc SOAP 1.1 request.

### Community 19 - "Infrastructure Reference Architecture"
Cohesion: 0.20
...
### Community 21 - "SOAP/WSDL Integration Surface"
Cohesion: 0.29
...
### Community 22 - "SOAP/WSDL Integration Surface"
Cohesion: 0.29
Nodes (7): Asynchronous Signing Workflow, getDocumentStatus GET/DELETE Lifecycle, Large-file SFTP and SHA-256 Transfer Procedure, Notification V1.0 WSDL, SignOneDoc, Synchronous Signing Workflow, SyncSign V3 WSDL

### Community 23 - "flow_orchestrator.py"
Cohesion: 0.40
Nodes (5): build_request(), build_step(), RVE Middleware Token — REST Bearer Token  Richiede un token Bearer presso l'API, Costruisce lo step token in forma compatibile con il Traffic Engine., Adapter per il contratto storico ``build_request`` dell'orchestratore.

### Community 24 - "Affinity Domain Italia"
Cohesion: 0.33
...
### Community 26 - "Edge Computing Latency"
Cohesion: 0.33
...
### Community 28 - "flow_orchestrator.py"
Cohesion: 0.67
Nodes (3): _build_body(), build_request(), ITI-43 - Retrieve Document Set  Richiede una SAML Assertion prodotta da RVE-1.b

### Community 29 - "flow_orchestrator.py"
Cohesion: 0.50
Nodes (3): build_request(), RVE-130 — REST Chiamata Contesto  Effettua la chiamata al servizio di contesto u, Costruisce lo step RVE-130 REST Chiamata Contesto.      Args:         config:

### Community 30 - "SI.Ter Dimensionamento Computazionale"
Cohesion: 0.50
...
- **Why does `RVE-121 GetAccessToken` connect `Progetto SI.Ter` to `_common.py`, `Corrected Middleware Flow Outcomes`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `E-RVE121-001` connect `Corrected Middleware Flow Outcomes` to `_common.py`, `Progetto SI.Ter`?**
